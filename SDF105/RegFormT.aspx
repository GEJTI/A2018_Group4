<%@ Page Language="C#" AutoEventWireup="true" CodeFile="RegFormT.aspx.cs" Inherits="RegistrationForm" %>
...
<body style="background-color: #7b6ee6; padding: 20px;">
    ...
    <form id="form1" runat="server">
        ...
        <div class="container" style="background-color: #ffffff; padding: 20px; border-radius: 8px;">
            ...
            <div class="col-md-12">
                <label><asp:Label runat="server" for="inputteacher_id" CssClass="form-label">Teacher ID Number&nbsp;</asp:Label><span style="font-size:10px">(NUMBERS ONLY) &nbsp</span><span style="color:red">*</span></label>
                <asp:TextBox runat="server" type="text" CssClass="form-control" ID="inputteacher_id" placeholder="Student Number" OnTextChanged="inputstud_id_TextChanged" required="true"/>
            </div>
            <br />
            <div class="col-md-12">
